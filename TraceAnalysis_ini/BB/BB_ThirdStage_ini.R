...
library(ini)
filename <- 'C:/Database/Calculation_Procedures/TraceAnalysis_ini/BB/BB_ThirdStage.ini'
yearsToProcess <- 2
yrs <- c(2023)
...
col_order <- names(ini_file$REddyProc_In)

# Specify variable names in REddyProc
var_names<-unlist(unname(ini_file$REddyProc_In))
